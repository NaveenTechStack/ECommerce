    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            if (!_roleManager.RoleExistsAsync(SD.Role_Customer).GetAwaiter().GetResult())
            {
                ...
                {
                    UserName = "mailnaveenkumar95@gmail.com",
                    Email = "mailnaveenkumar95@gmail.com",
                    Name = "Naveen",
                ...
                ApplicationUser user = _db.ApplicationUsers.FirstOrDefault(u => u.Email == "mailnaveenkumar95@gmail.com");
